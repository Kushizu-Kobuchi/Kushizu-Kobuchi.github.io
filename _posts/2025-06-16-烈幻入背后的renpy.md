...
![alt text](PixPin_2025-06-20_18-28-21.gif)
...
`Frame`是所谓的九宫格切图，一般用于UI界面，比如窗口、按钮、聊天气泡这种希望可以随意伸缩的组件。[示意图](http://yannickloriot.com/2011/12/create-buttons-in-cocos2d-by-using-cccontrolbutton/)如下：
